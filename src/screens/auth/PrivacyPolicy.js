            ...
            <ScrollView style={layoutStyle.container}>
                ...
                <View style={layoutStyle.textWrapper}>
                    ...
                    <Text style={layoutStyle.text}>
                        built the Daily Meditation:Simple Habit app as an Open Source app. This SERVICE is provided by App developer at no cost and is intended for use as is.
                   </Text>
                    <Text style={layoutStyle.text}>
                        This page is used to inform visitors regarding my policies with the collection, use, and disclosure of Personal Information if anyone decided to use my Service.
   If you choose to use my Service, then you agree to the collection and use of information in relation to this policy. The Personal Information that I collect is used for providing and improving the Service. I will not use or share your information with anyone except as described in this Privacy Policy.
   The terms used in this Privacy Policy have the same meanings as in our Terms and Conditions, which is accessible at Daily Meditation:Simple Habit unless otherwise defined in this Privacy Policy.
...
* Google Play Services
 ...
 This Service does not use these “cookies” explicitly. However, the app may use third party code and libraries that use “cookies” to collect information and improve their services. You have the option to either accept or refuse these cookies and know when a cookie is being sent to your device. If you choose to refuse our cookies, you may not be able to use some portions of this Service.
    ...
    * To assist us in analyzing how our Service is used.
    I want to inform users of this Service that these third parties have access to your Personal Information. The reason is to perform the tasks assigned to them on our behalf. However, they are obligated not to disclose or use the information for any other purpose.are obligated not to disclose or use the information for any other purpose.
                    ...
                    <Text style={layoutStyle.text}>
                        These Services do not address anyone under the age of 13. I do not knowingly collect
                             ...
                             with personal information, please contact me so that I will be able to do necessary actions.    </Text>
                    <Text h4 style={layoutStyle.textTitle}>
